class Opponent extends Phaser.GameObjects.Container{
    constructor(scene, x, y){
        ...
        scene.physics.add.collider(this.fireGroup, scene.player, (bullet, player) => {
            bullet.destroy()
        })

        scene.physics.add.collider(this.alienGroup, scene.player, (bullet, player) => {
            bullet.destroy()
        })

        scene.physics.add.collider(this.laserGroup, scene.player, (bullet, player) => {
            bullet.destroy()
        })

        scene.physics.add.collider(this.rifleGroup, scene.player, (bullet, player) => {
            bullet.destroy()
        })
